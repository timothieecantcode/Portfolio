  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 py-20 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <span className="absolute -inset-x-10 -inset-y-6 bg-white/1 rounded-3xl blur-3xl -z-10"></span>
          <motion.span
          ...
          <motion.span
            ...
            variants={textVariants}
          >
            crafting smart, modern software that actually works.
          </motion.span>
        </motion.h1>
        ...
        >
          Mixing clean design, solid code, and a ton of caffeine power.
        </motion.p>

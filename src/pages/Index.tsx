  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <header className="fixed w-full top-0 z-50 bg-[#101010] backdrop-blur-md border-b border-white/10">
          <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            <h1 className="text-xl font-bold italic" style={{ fontFamily: "'Playwrite CZ', sans-serif" }}>Timothie Nguyen</h1>
        ...
        <footer className="py-12 px-4 border-t border-white/10 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            <p className="text-white/60">
              © {new Date().getFullYear()} Timothie Nguyen. All rights reserved.
            </p>
          </div>
        </footer>
      </motion.div>
